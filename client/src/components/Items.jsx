  ...
  <div className="blog-slider__wrp swiper-wrapper">
    <div className="blog-slider__item swiper-slide">
      ...
      <div className="blog-slider__content">
        <span className="blog-slider__code">Housify</span>
        <div className="blog-slider__title">Housify your income will got height initul they reach the sky</div>
        <div className="blog-slider__text">When it comes to home listings, words are only part of the story. Professional-quality staging photos also are essential to increasing consumer interest, and should be considered an integral component of your listing description.
