...
function Aganse(props) {
  ...
  <ul className="cards">
    <li onClick={()=>{navigate("/cal")}}><img src="https://ca.slack-edge.com/T0483L108BH-U048V16SNNQ-cb5692bb4eaa-512"/>
    ...
    <li  onClick={()=>{navigate("/cal")}}><img src="https://ca.slack-edge.com/T0483L108BH-U048SEB23HQ-ed8605b67dd4-512"/>
    ...
    <li  onClick={()=>{navigate("/cal")}}><img src="https://ca.slack-edge.com/T0483L108BH-U04958DUXGR-680ceb6790cd-512"/>
    ...
    <li  onClick={()=>{navigate("/cal")}}><img src="https://ca.slack-edge.com/T0483L108BH-U04953VKMDX-3b587064bd88-512"/>
